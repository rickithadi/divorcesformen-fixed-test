...
const DEFAULT_SITE_TITLE = 'Divorce Attorney | St Petersburg, FL | Divorce for Men–Alan Rosenthal';
const DEFAULT_DESCRIPTION = 'Divorce for Men’s’ Attorney Alan Rosenthal in St. Petersburg, FL will help men who are filing for divorce. Call 727-347-2299.';
const DEFAULT_CANONICAL_URL = 'https://www.divorcesformen.com/';
const DEFAULT_AUTHOR = 'Divorce Attorney | St Petersburg, FL | Divorce for Men–Alan Rosenthal';
const DEFAULT_OG_LOCALE = 'en_US';
const DEFAULT_SITE_IDENTIFIER = 'Divorce';
const DEFAULT_PHONE = '(727)347-2299';
